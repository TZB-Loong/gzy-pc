...
@connect(({ doneProcessModel, loading }) => ({
  doneProcessModel,
  loading: loading.effects['doneProcessModel/fetch'],
}))
export default class doneProcess extends Component {
  state = {
    searchText: '',
    currentTaskName: '',
    arriveTime: '',
  ...
  doneTaskList() {
    ...
    dispatch({
      ...
      if (!isfalse(doneProcessModel.doneTaskList)) {
        let doneTaskList = doneProcessModel.doneTaskList;
        // console.log(doneTaskList);
        this.setState({
          totalPages: doneTaskList.total ? doneTaskList.total : 1,
        });
      }
    });
  }
  ...
  render() {
    ...
    return (
      <Spin spinning={loading}>
        <PageHeaderLayout>
          <Card title={doneProcessModel.data}>
            ...
            <List
              ...
              dataSource={
                doneProcessModel.doneTaskList.records ? doneProcessModel.doneTaskList.records : []
              }
              renderItem={item =>
