      ...
      <div className={clsString}>
        ...
        {this.props.contentTitle ? (
          <div style={{ paddingBottom: 10 }}>
            <span style={{ backgroundColor: '#4B85F8', display: 'inline-block', width: 3 }}>
              &nbsp;
            </span>
            <span style={{ fontSize: 20, fontWeight: '900', color: '#333757', marginLeft: 10 }}>
              {this.props.contentTitle}
            </span>
            <span style={{ marginLeft: 20, color: '#EE7356' }}>
              <Icon style={{ color: '#ffe500', marginRight: 5 }} type="exclamation-circle" />
              注意：如本页面内容与招标方提供的招标文件内容有冲突，请以招标文件为准
            </span>
          </div>
        ) : null}
      </div>
